...
angular.module('inspinia').factory('error', function() {
...
function config($httpProvider,$stateProvider, $urlRouterProvider, $ocLazyLoadProvider, IdleProvider, KeepaliveProvider) {
